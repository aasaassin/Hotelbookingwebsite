...
<body class="bg-light">
            ...
            <?php
                    ...
                    while($room_data = mysqli_fetch_assoc($room_res)){
                        ...
                        <div class="card border-0 shadow" style="max-width: 350px; margin: auto">
                            <img src="$room_thumb" style="height: 197px" class="card-img-top" />
                            <div class="card-body">
                                ...
                                <div class="guests mb-4">
                                    ...
                                    <span class="badge rounded-pill bg-light text-dark text-wrap"> $room_data[adult] người lớn </span>
                                    <span class="badge rounded-pill bg-light text-dark text-wrap"> $room_data[children] trẻ em </span>
                                </div>
                                ...
                                <div class="d-flex justify-content-evenly mb-2">
                                    ...
                                    <a href="room_details.php?id=$room_data[id]" class="btn btn-sm btn-outline-dark custom-bg shadow-none">Xem thêm</a>
                                </div>
                            </div>
                        </div>
                        </div>
    ...
    <div class="container">
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
            ...
            <div class="col-lg-12 text-center mt-5">
                <a href="facilities.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">Xem
                    thêm>>></a>
            </div>
        </div>
    </div>
