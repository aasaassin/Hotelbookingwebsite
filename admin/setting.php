                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input name="site_title" type="text" id="site_title_inp" required
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input name="address" type="text" id="address_inp" required
                                                    class="form-control shadow-none" />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label fw-bold">Goole map</label>
                                                <input name="gmap" type="text" id="gmap_inp" required
                                                    class="form-control shadow-none" />
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="email" type="email" id="email_inp" required
                                                    class="form-control shadow-none" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="iframe" type="text" id="iframe_inp" required
                                                    class="form-control shadow-none" />
                                            </div>
                                        </div>
                                    </div>
